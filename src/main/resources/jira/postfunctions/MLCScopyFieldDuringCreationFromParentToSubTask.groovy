...
def lazyValues = parentSubComponentCFValue.findAll{ it instanceof com.atlassian.jira.issue.customfields.option.LazyLoadedOption }
...
def SubComponentCFfromChild = ComponentAccessor.customFieldManager.getCustomFieldObjects(issue).find {it.name == 'Sub-Component'}
