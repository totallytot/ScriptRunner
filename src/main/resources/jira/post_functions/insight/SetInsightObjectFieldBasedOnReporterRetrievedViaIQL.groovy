...
def insightCF = ComponentAccessor.getCustomFieldManager().getCustomFieldObject(10267)
...
ComponentAccessor.getIssueManager().updateIssue(executionUser, issue, EventDispatchOption.DO_NOT_DISPATCH, false)