...
enum CrSlaFieldMapping {
    CR_3("CR 3d", 3, "customfield_11676", "CR_target_3"),
    CR_7("CR 7d", 7, "customfield_11677", "CR_target_7"),
    ...
    CrSlaFieldMapping(String slaName, int days, String fieldId, String fieldName) {
...
logger.info "CR ISSUE TYPE LISTENER START"
...
logger.info "CR ISSUE TYPE LISTENER END"
